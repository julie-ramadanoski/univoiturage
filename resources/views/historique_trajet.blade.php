                        ...
                        <div class="list-item">
                            <div class="panel panel-primary">
                                <div class="panel-heading" style="height: 40px;">
                                    ...
                                    <div class="col-sm-3">Trajet N° {{ $trajet->idTraj }} le {{ date('d F Y', strtotime($trajet->dateTraj)) }} à {{ $trajet->heureTraj }}</div>
                                    <div class="col-sm-8">Réservation : {{$res}}</div>
                                </div>
